...
CREATE TABLE Rodziny (
    ID_Rodzina INT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    Nazwisko_Rodziny TEXT NOT NULL
);

CREATE TABLE Osoby_Rodziny (
    ID_Osoby_Rodziny INT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    ID_Osoba INT NOT NULL,
    ID_Rodzina INT NOT NULL,
    FOREIGN KEY (ID_Osoba) REFERENCES Osoby(ID_Osoba),
    FOREIGN KEY (ID_Rodzina) REFERENCES Rodziny(ID_Rodzina)
);
...
CREATE TABLE Osoby_Zwiazki (
    ID_Osoby_Zwiazki INT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    ID_Osoba INT NOT NULL,
