...
-- ================================================================
-- PONIŻEJ: DODANE PRZEZ CHATGPT ZDARZENIA, MIEJSCA I POWIĄZANIA
-- ================================================================
...
OVERRIDING SYSTEM VALUE
VALUES
  ( 1,'Szpital Uniwersytecki w Krakowie',                'Szpital przy ul. Kopernika 36 w Krakowie',                               POINT(50.0669 19.9500)),
  ( 2,'Szpital Kliniczny Dzieciatka Jezus w Warszawie',   'Szpital kliniczny przy ul. Lindleya 4 w Warszawie',                       POINT(52.2228 21.0038)),
  ( 3,'Urzad Stanu Cywilnego Krakow',                     'USC Krakow, ul. Lubelska 29',                                             POINT(50.0736 19.9400)),
  ( 4,'Urzad Stanu Cywilnego Warszawa',                   'USC Warszawa, ul. Andersa 5',                                             POINT(52.2500 21.0000)),
  ( 5,'Cmentarz Rakowicki',                               'Cmentarz komunalny w Krakowie przy ul. Rakowickiej',                       POINT(50.0730 19.9650)),
  ( 6,'Cmentarz Powazkowski',                             'Stary cmentarz w Warszawie przy ul. Powazkowskiej',                        POINT(52.2570 20.9790));
...
OVERRIDING SYSTEM VALUE
VALUES
  (  1,  5,  1), -- Barbara narodziny,
  (  2,  6,  2), -- Roman narodziny,
  (  3,  7,  3), -- Zofia narodziny,
  (  4,  8,  4), -- Jakub narodziny,
  (  5,  9,  5), -- Natan narodziny,
  (  6, 10,  6), -- Agata narodziny,
  (  7, 11,  7), -- Andrzej narodziny,
  (  8, 12,  8), -- Alicja narodziny,
  (  9, 13,  9), -- Antoni narodziny,
  ( 10, 14, 10), -- Alex narodziny,
  ( 11, 15, 11), -- Ada narodziny,
  ( 12,  6, 12), -- Roman smierc,
  ( 13,  9, 13), -- Natan smierc,
  ( 14,  5, 14), -- Barbara slub,
  ( 15,  6, 14), -- Roman slub,
  ( 16,  7, 15), -- Zofia slub,
  ( 17,  8, 15), -- Jakub slub,
  ( 18, 10, 16), -- Agata slub,
  ( 19, 11, 16)  -- Andrzej slub;
